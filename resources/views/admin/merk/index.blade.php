                             ...
                             <td>
                                 <div class="flex align-items-center list-user-action">
                                     <a class="btn btn-sm bg-secondary" data-toggle="tooltip" data-id="{{ $row->id }}" data-placement="top" title=""
                                         data-original-title="Edit" href="{{ url('/merkbarang/' . $row->id . '/edit' )}}"><i class="ri-pencil-line mr-0"></i></a>
...
<script>
   $('.delete').click(function(){
           ...
           var url = "{{ route('merkbarang.destroy', ':merk_id') }}";
           ...
           .then((willDelete) => {
               ...
               if (willDelete) {
                   window.location = "/merkbarang/"+merk_id+"/destroy";
