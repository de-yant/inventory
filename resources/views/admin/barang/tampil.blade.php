          ...
          <div class="card card-block card-stretch card-height">
             <div class="card-header d-flex justify-content-between">
                <div class="iq-header-title">
                   <h4 class="card-title mb-0">Detail Data Barang</h4>
                </div>
             ...
             <div class="card-body">
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        <center>
                            <img src="{{ asset('images/'.$barang->barang_gambar) }}" alt="" style="width: 400px">
                        </center>
                    </div>
                ...
                <div class="form-row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="jenis_id" class="form-control" readonly value="{{ $barang->jenisbarang->jenisbarang_nama }}">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="satuan_id" class="form-label">Satuan Barang</label>
                           <input type="text" name="satuan_id" class="form-control" readonly value="{{ $barang->satuanbarang->satuanbarang_nama }}">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="merk_id" class="form-label">Merk Barang</label>
                               <input type="text" name="merk_id" class="form-control" readonly value="{{ $barang->merkbarang->merkbarang_nama }}">
                        </div>
                        <div class="col-md-3 mb-3">
