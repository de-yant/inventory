...
<div class="container-fluid">
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a class="btn btn-sm bg-secondary" data-toggle="tooltip" data-id="{{ $row->id }}" data-placement="top" title=""
                                            data-original-title="Edit" href="{{ url('/jenisbarang/' . $row->id . '/edit' )}}"><i class="ri-pencil-line mr-0"></i></a>
 ...
 <script>
    $('.delete').click(function(){
            ...
            var url = "{{ route('jenisbarang.destroy', ':jenis_id') }}";
            ...
            .then((willDelete) => {
                ...
                if (willDelete) {
                    window.location = "/jenisbarang/"+jenis_id+"/destroy";
